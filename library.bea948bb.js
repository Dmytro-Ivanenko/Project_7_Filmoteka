 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oe{constructor(){this._=void 0}}function Me(t,e,n){return t instanceof Fe?Be(t,e):t instanceof je?Ve(t,e):n}function Pe(t,e){var n,i;return t instanceof ze?It(n=e)||(i=n)&&"doubleValue"in i?e:{integerValue:0}:null}class Ue extends Oe{}class Fe extends Oe{constructor(t){super(),this.elements=t}}function Be(t,e){const n=qe(e);for(const e of t.elements)n.some((t=>wt(t,e)))||n.push(e);return{arrayValue:{values:n}}}class je extends Oe{constructor(t){super(),this.elements=t}}function Ve(t,e){let n=qe(e);for(const e of t.elements)n=n.filter((t=>!wt(t,e)));return{arrayValue:{values:n}}}class ze extends Oe{constructor(t,e){super(),this.yt=t,this.gt=e}}function We(t){return ft(t.integerValue||t.doubleValue)}function qe(t){return St(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve=new C(3e4,6e4);function ze(){const t=te().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let We=null;function qe(t){return We=We||function(t){return new Promise(((e,n)=>{var i,r,s;function o(){ze(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{ze(),n(m(t,"network-request-failed"))},timeout:Ve.get()})}if(null===(r=null===(i=te().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)e(gapi.iframes.getContext());else{if(!(null===(s=te().gapi)||void 0===s?void 0:s.load)){const e=de("iframefcb");return te()[e]=()=>{gapi.load?o():n(m(t,"network-request-failed"))},fe(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}o()}})).catch((t=>{throw We=null,t}))}(t),We}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
...
//# sourceMappingURL=library.bea948bb.js.map
